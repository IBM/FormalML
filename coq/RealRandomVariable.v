...
Lemma measurable_continuous (f : Ts -> R) (g : R -> R) :
 ...
 Qed.
  ...
  Global Instance Rabs_measurable f :
    RealMeasurable f ->
...
Section SimpleExpectation.
 ...
 Lemma rvminus_equiv (f g : Ts -> R) :
  ...
  Proof.
    red; intros.
    apply borel_sa_preimage2; trivial; intros.
    assert (RealMeasurable rv_X).
    red; intros. eapply RealRandomVariable_is_real; eauto.
    eapply rmeasurable.
   Qed.
...
*)
  ...
  Proof.
    ...
    generalize (@sa_sigma_inter_pts _ _ _ rv_X1 rv_X2 rv1 rv2); intros sa_sigma.
  ...
  Lemma sumSimpleExpectation_nempty
   ...
   Proof.
    ...
    generalize (@sa_sigma_inter_pts _ _ _ rv_X1 rv_X2). intro sa_sigma.
    destruct srv1.
    destruct srv2.
