...
Definition independent {A:Type} (p:Pmf A) (f g : A -> R) :=
  forall r1 r2, 𝕡[ preim_outcomes_of_pair_And p f g r1 r2] = 𝕡[preim_outcomes_of p f r1]*𝕡[preim_outcomes_of p g r2]. 
...
{A : Type} {r : R} {f g : A -> R} {p : Pmf A}(hne : 0 <> 𝕡[preim_outcomes_of p g r]) (Hi : independent_aux_prop p f g) :
  cond_expt_value hne f = expt_value p f.
Proof.
  unfold cond_expt_value. unfold independent_aux_prop in Hi. specialize (Hi r).
  rewrite Hi. unfold prob,preim_outcomes_of.
