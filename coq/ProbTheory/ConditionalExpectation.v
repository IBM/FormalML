...
(*
  ...
  Proof.
    ...
    pose (An := fun x:R => fun omega => 
    
    pose (Ge := fun x:R => (fun omega => (event_inter (event_Rbar_ge ce2 (ce1 omega)) (event_Rbar_ge x (ce1 omega))))).

    pose (Ge := fun x:Ts => (event_inter (event_Rbar_ge ce2 ce1) (event_Rbar_ge x ce1))).
